...
sub.to_csv(f"baseline4_exp_assign_artist_features_inplace_refactoredstd_assign_value_redesigned_refactored_{mean_rmse:.4f}_{std_rmse:.4f}.csv", index=False, header=False)
