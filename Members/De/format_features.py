...
def format_features(df):
    ...
    df["_artist_id_max_cat"] = df["artist_id_max"].astype('category')
    df["_artist_id_max_cat"] = df["_artist_id_max_cat"].cat.codes

    df["_composers_id_min_cat"] = df["composers_id_min"].astype('category')
    df["_composers_id_min_cat"] = df["_composers_id_min_cat"].cat.codes
        
    df["_composers_id_max_cat"] = df["composers_id_max"].astype('category')
    df["_composers_id_max_cat"] = df["_composers_id_max_cat"].cat.codes
